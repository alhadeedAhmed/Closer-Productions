...
export default function ProfitablerateAdNavbar() {
  ...
  useEffect(() => {
    ...
    const atOptions = {
      key: 'd5e9946bf4b393ea99c0011aa7d1051c',
      format: 'iframe',
      height: 50,
      width: 320,
      params: {},
  ...
  return (
    <div
      ...
      style={{ width: 280, height: 50, background: '#f5f5f5', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
      ref={bannerRef}
    />
  );
}
